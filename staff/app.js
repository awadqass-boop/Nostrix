...
async function loadNotifs(){if(!S.user)return;let{data}
...
=await S.db.from("notifications").select("*").eq("user_id",S.user.id).order("created_at",{ascending:false}).limit(40);S.notifications=data||[]}
